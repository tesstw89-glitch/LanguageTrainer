...
struct ListenWriteView: View {
    ...
    private var totalQs: Int { totalQsOverride ?? 12 }
    ...
    var body: some View {
        ZStack {
            ...
            VStack(spacing: 16) {
                ...
                // ✅ English hidden unless revealed
                ...
                // ✅ Foreign sentence hidden unless revealed
                if isSentenceRevealed, let fr = current?.foreign {
                    Text(cleanForWrite(fr))
                ...
                TextField("Type what you hear…", text: $typed)
                    ...
                    .padding(.horizontal, 18)
                    .focused($isFocused)
                    .onChange(of: typed) { _, _ in checkAnswer() }
    ...
    private func play() {
        ...
        speaker.speak(sentence, languageCode: speechCode)
    }
